...
#[cfg(all(
    not(feature = "1.8.14"),
    all(target_env = "msvc", not(feature = "static"))
))]
mod globals {
    // dllimport hack
    pub type id_t = usize;
...
mod globals {
    ...
    extern_static!(
        ...
        __imp_H5P_CLS_ATTRIBUTE_CREATE_ID_g
    );
    ...
    extern_static!(
        ...
        __imp_H5P_LST_ATTRIBUTE_CREATE_ID_g
    );
    ...
    pub mod globals {
        ...
        extern_static!(
            ...
            __imp_H5P_LST_VOL_INITIALIZE_ID_g
        );
        extern_static!(
            H5P_REFERENCE_ACCESS_DEFAULT,
            __imp_H5P_LST_REFERENCE_ACCESS_ID_g
        );
    }
    #[cfg(feature = "1.12.0")]
    pub use globals::*;
...
extern "C" {
    pub fn H5Pcreate_class(
        ...
        create_data: *mut c_void,
        cls_copy: H5P_cls_copy_func_t,
        copy_data: *mut c_void,
    ...
    pub fn H5Pget_vlen_mem_manager(
        ...
        alloc_info: *mut *mut c_void,
        free_func: *mut H5MM_free_t,
        free_info: *mut *mut c_void,
    ) -> herr_t;
    ...
    pub fn H5Pset_est_link_info(
        plist_id: hid_t,
        est_num_entries: c_uint,
        est_name_len: c_uint,
    ) -> herr_t;
    pub fn H5Pget_est_link_info(
        plist_id: hid_t,
        est_num_entries: *mut c_uint,
        est_name_len: *mut c_uint,
    ) -> herr_t;
...
extern "C" {
    ...
    pub fn H5Pget_fapl_direct(
        fapl_id: hid_t,
        alignment: *mut size_t,
        block_size: *mut size_t,
        cbuf_size: *mut size_t,
    ) -> herr_t;
}
...
mod mpio {
    ...
    extern "C" {
        ...
        pub fn H5Pset_dxpl_mpio_chunk_opt_ratio(
            dxpl_id: hid_t,
            percent_num_proc_per_chunk: c_uint,
        ) -> herr_t;
    }
}
...
extern "C" {
    ...
    pub fn H5Pset_mdc_image_config(
        plist_id: hid_t,
        config_ptr: *const H5AC_cache_image_config_t,
    ) -> herr_t;
    ...
    pub fn H5Pget_page_buffer_size(
        plist_id: hid_t,
        buf_size: *mut size_t,
        min_meta_per: *mut c_uint,
        min_raw_per: *mut c_uint,
    ) -> herr_t;
...
extern "C" {
    pub fn H5Pget_file_locking(
        ...
        ignore_when_disable: *mut hbool_t,
    ) -> herr_t;
    pub fn H5Pset_file_locking(
        fapl_id: hid_t,
        use_file_locking: hbool_t,
        ignore_when_disable: hbool_t,
    ) -> herr_t;
