...
def test_load_events_time_window():
    ...
    try:
        ...
        loaded_xs1, loaded_ys1, loaded_ts1, loaded_ps1 = load_events_py(
            file_path, t_start=t_min, t_end=t_mid
        )
        
        # Load second half of events
        loaded_xs2, loaded_ys2, loaded_ts2, loaded_ps2 = load_events_py(
            file_path, t_start=t_mid, t_end=t_max
        )
...
def test_load_events_polarity_filter():
    ...
    try:
        ...
        loaded_pos_xs, loaded_pos_ys, loaded_pos_ts, loaded_pos_ps = load_events_py(
            file_path, polarity=1
        )
        
        # Load negative events
        loaded_neg_xs, loaded_neg_ys, loaded_neg_ts, loaded_neg_ps = load_events_py(
            file_path, polarity=-1
        )
