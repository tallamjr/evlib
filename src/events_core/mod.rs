...
/// Legacy function for Python compatibility - events to block representation
#[pyfunction]
pub fn events_to_block<'py>(
    py: Python<'py>,
    xs: numpy::PyReadonlyArray1<i64>,
    ys: numpy::PyReadonlyArray1<i64>,
    ts: numpy::PyReadonlyArray1<f64>,
    ...
    // Forward to the new implementation in the python module
    python::events_to_block_py(py, xs, ys, ts, ps)
}
