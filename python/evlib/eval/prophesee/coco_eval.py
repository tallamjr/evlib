...
(utils/evaluation/prophesee/metrics/coco_eval.py). The only adaptation is import
paths. The detectron2 fast eval API remains an optional speedup: if it is not
installed we fall back to the pure-pycocotools COCOeval.
