"""Top-level Prophesee detection evaluation entry point.

Ported near-verbatim from the RVT reference
(utils/evaluation/prophesee/evaluation.py); only import paths are adapted.
"""
...
def evaluate_list(
    ...
    if apply_bbox_filters:
        ...
        def filter_boxes_fn(x):
            return filter_boxes(x, half_sec_us, min_box_diag, min_box_side)
